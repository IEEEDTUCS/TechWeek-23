            ...
            <div className='bg-[#414141] rounded-lg w-full gap-2 h-full px-[20px]'>
                <div className='content-center footer1'>
                    <div className='flex flex-col items-center justify-center flex-nowrap'>
                        ...
                        <div className='text-[#BECACA] mx-4 text-md bsh'>
                            TechWeek by IEEE-DTU
                            <br />
                            <div className="flex hidsm">
                                Powered By:&nbsp;&nbsp;
                                <a href="" target="_blank" aria-label="unstoplink">
                                    <Image src={Unstop} height={40} width={90} alt="unstoplogo" className="h-8" />
                                </a>
                            </div>
                            <div className="hidsm2">
                                ...
                                <a href="https://unstop.com/" target="_blank" aria-label="unstoplink2">
                                    <Image src={Unstop} alt="unstoplogo" className="h-8" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className='text-[#fff] text-lg font-bold py-2 bsh'>
                        ...
                        <div className='flex flex md:flex-row items-center justify-start'>
                            ...
                            <div className=' bscflex flex-col items-start justify-center'>
                                <div className='text-[#BECACA] mx-4 text-md bsc'>
                                    Shahbad Daulatpur, Bawana Road
                                </div>
                                <div className='text-[#BECACA] mx-4 text-md bsc'>
                                    Delhi - 110042
                                </div>
                                <div className='text-[#BECACA] mx-4 text-md'>
                    ...
                    <div className='text-[#BECACA] mx-4 text-md flex flex-col items-start justify-start '>
                        <div className='text-[#fff] text-lg py-2 bsh'>
                            <b className=''>
                                Designed by
                            </b>
                        </div>
                        <span className='flex items-center justify-between'>
                            <div className='pr-1 bsc'>
                                Prashant
                            </div>
                        ...
                        <span className='flex items-center justify-between'>
                            ...
                            <a aria-label="link16" href='https://www.linkedin.com/in/gitansh-mehta/' target='_blank' rel='noreferrer' className='pt-1'>
